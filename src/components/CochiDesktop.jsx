...
const css = `
  ...
  .cd-spinner {
    ...
    border-top-color: ${THEME.celeste};
    border-radius: 50%;
          ...
          <div style={{
            ...
            <div>
              <span style={{
                ...
                background:`linear-gradient(135deg, ${THEME.celeste} 25%, ${THEME.gold} 100%)`,
              ...
              <span style={{
                fontSize:'1.2rem', letterSpacing:'0.22em', color:THEME.gold,
                textTransform:'uppercase', fontFamily:"'Space Grotesk',sans-serif",
                fontWeight:700, marginLeft:14
              }}>
                COCHI ASISTENTE
              </span>
            </div>
              ...
              return (
                <button
                  ...
                  style={{
                    ...
                    background: isActive
                      ? `linear-gradient(160deg, rgba(65,66,62,0.5) 0%, ${THEME.bgMain} 100%)`
                      : 'rgba(55,75,82,0.25)',
                  ...
                  onMouseLeave={e => {
                    if (!isActive) {
                      e.currentTarget.style.color = THEME.textLow
          ...
          <div style={{
            ...
            >
              ...
              <div style={{ display:'flex', gap:10 }}>
                <textarea
                  ...
                  style={{
                    ...
                    letterSpacing:'0.02em', resize:'none', overflow:'hidden',
                    lineHeight:1.6
                  }}
                />
                <button
                  ...
                  style={{
                    ...
                    cursor: state.loading || !state.input.trim() ? 'not-allowed' : 'pointer',
                    fontFamily:"'Space Grotesk',sans-serif",
                    textTransform:'uppercase',
                  ...
                  onMouseEnter={e => {
                    if (!state.loading && state.input.trim()) {
              ...
              <div style={{
                ...
                paddingTop:8, marginTop:8, borderTop:`1px solid ${THEME.metallicGray}`
              }}>
                <div style={{
                  display:'flex', gap:8, alignItems:'center',
                  fontSize:'0.8rem', fontFamily:"'JetBrains Mono',monospace",
                  color:tc.color, letterSpacing:'0.05em'
                }}>
                  {state.loading && <span className="cd-spinner" />}
                ...
                <div style={{
                  ...
                  <button onClick={handleClear} style={{
                    ...
                    borderRadius:6, padding:'2px 8px', color:THEME.textMed,
